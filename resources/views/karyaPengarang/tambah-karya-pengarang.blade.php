        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Karya Pengarang Perpustakaan</h1>
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        ...
                        <form action="{{ route('simpan-karya-pengarang') }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input type="text" class="form-control" placeholder="Masukan Karya Pengarang"
                                    aria-label="alamat" aria-describedby="basic-addon1" name="karyaPengarang" required>
                            </div>
