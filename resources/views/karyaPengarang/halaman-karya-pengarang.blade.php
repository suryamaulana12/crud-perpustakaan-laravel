        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Data Karya Pengarang Perpustakaan</h1>
                ...
                <div class="row">
                    <div class="card-body">
                        <a href="{{ route('tambah-karya-pengarang') }}"><button type="button"
                        ...
                        <table class="table table-hover col-12 text-center justify-content-center">
                            ...
                            @foreach ($peng as $item)
                                <tbody class="table-striped">
                                    ...
                                    <td>
                                        <a href="{{ url('edit-karya-pengarang', $item->id) }}"><button type="submit"
